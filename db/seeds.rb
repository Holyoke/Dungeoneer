...
user_jane = User.create(name: "Jane", email: "jane@jobwalk.com", password: "test1234", role: 'collaborator')
user_joe = User.create(name: "Joe", email: "joe@jobwalk.com", password: "test1234", role: 'collaborator')
